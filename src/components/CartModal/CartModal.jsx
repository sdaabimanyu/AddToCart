        ...
        <div className="fixed inset-0 min-h-screen bg-opacity-50 flex justify-center items-center audiowide-regular ">
            <div
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    <div id="leftSdCart" className="w-full md:w-[65%] h-[350px] bg-black p-4 sm:p-0 md:p-3 rounded-xl text-white border flex flex-col  gap-y-3 overflow-y-auto">
                        {props.cartItemsLength === 0 ? (
                            ...
                            props.cartItems.map((item, index) => (
                                <div key={item.id} className="flex w-full gap-x-5 relative p-3 rounded-lg poppins  border-b border-white/50 last:border-b-0">
                    ...
                    <div id="rightSdCart" className=" w-[full] md:w-[35%] h-[350px] bg-black rounded-xl p-4 text-white">
                        ...
                        <div className="flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-center items-center">
                                <button className="w-[200px] h-[50px] rounded-lg text-black font-semibold bg-white items-center cursor-pointer">Proceed To Checkout</button>
                            </div>
                        </div>
